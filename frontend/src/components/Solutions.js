  ...
  const solutionsData = [
    {
      ...
      description: "Kích hoạt và theo dõi bảo hành chỉ với một lần quét QR. Nhanh chóng, tiện lợi, nâng tầm trải nghiệm khách hàng.",
      list: [
      ...
      slides: ["/assets/cuspic1.png", "/assets/cuspic2.png","/assets/pic3.png","/assets/pic4.png"]
    },
    {
      id: 2,
